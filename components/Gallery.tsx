...
export function Gallery({ birds, onOpenAdmin, isAuthenticated }: GalleryProps) {
  ...
  // Auto-deselect bird when sidebar collapses (only on mobile or manual collapse)
  useEffect(() => {
  ...
  const handleBirdSelect = (birdId: number) => {
    if (selectedBirdId === birdId) {
      ...
      setIsPlayingAudio(false); // Stop any playing audio when selecting new bird
      
      // Auto-expand sidebar if collapsed when selecting a bird
  ...
  // Handle about page (placeholder for now)
  const handleAbout = () => {
    console.log('About page requested');
    // TODO: Implement about page/modal
  };

  // Handle submit quote (placeholder for now)
  const handleSubmitQuote = () => {
    console.log('Submit quote requested');
    // TODO: Implement quote submission form
  };
  ...
  // Create mobile modal content component
  const MobileBirdModal = () => {
    if (!selectedBird) {
      console.log('MobileBirdModal: No selected bird');
      return null;
    }

    console.log('MobileBirdModal: Rendering modal for bird:', selectedBird.species, 'showMobileModal:', showMobileModal);

    return (
      <Dialog open={showMobileModal} onOpenChange={(open) => {
        console.log('Dialog onOpenChange:', open);
        setShowMobileModal(open);
      }}>
        <DialogContent className="mobile-bird-modal fixed inset-0 w-full h-full max-w-none max-h-none p-0 rounded-none border-0 z-[10000] overflow-hidden bg-white">
          {/* Accessible Dialog Title and Description - Hidden but available to screen readers */}
          <VisuallyHidden>
            <DialogTitle>
              {selectedBird.species} - Literary Bird Details
            </DialogTitle>
            <DialogDescription>
              View detailed information about {selectedBird.species} including literary quote, bird details, and audio controls. Navigate between birds using the Previous, Next, and Random buttons.
            </DialogDescription>
          </VisuallyHidden>
          
          <div className="h-full flex flex-col literary-sidebar" style={{ backgroundColor: '#faeee6' }}>
            {/* Mobile Header with Close Button */}
            <div className="flex items-center justify-between p-4 border-b border-gray-200">
              <h2 
                className="font-bold italic leading-[0] text-[#856658] text-[20px] text-left text-nowrap"
                style={{ 
              ...
              <div className="flex items-center gap-2">
                <Button
                  ...
                  className="w-8 h-8 p-0 mute-button"
                  style={{ color: '#856658' }}
            ...
            <ScrollArea className="flex-1">
              <div className="p-6 flex flex-col gap-[25.25px]">
                {/* Featured Bird Image */}
                <div className="h-[73px] relative w-[54px] mx-auto cursor-pointer" onClick={playBirdCall}>
                  <SvgImage
                ...
                <div className="flex flex-col gap-4 items-center w-full">
                  <blockquote 
                    className="font-semibold italic leading-[normal] text-[#160e0c] text-[28px] text-center w-full"
                    style={{ 
                      fontFamily: 'Cormorant, serif'
                    }}
                  >
                    ...
                    <div className="order-2 relative shrink-0 size-6">
                      ...
                      >
                        ...
                        {isPlayingAudio ? (
                          ...
                          // Play icon
                          <path d={svgPaths.p2258ac80} fill="#CCAE9D" />
                        )}
                      </svg>
                    </div>
                ...
                <div className="[flex-flow:wrap] flex gap-3.5 h-[78.081px] items-start justify-center p-0 w-full">
                  <div className="flex flex-row gap-[6.765px] items-center justify-center overflow-clip p-[9.02px] rounded-[9.02px] cursor-pointer hover:bg-[#f0e6dd] transition-colors">
                    <div 
                  ...
                  <div 
                    className="bg-[#fff8f2] flex flex-row gap-[6.765px] items-center justify-center overflow-clip p-[9.02px] rounded-[9.02px] cursor-pointer hover:bg-[#f5ede4] transition-colors"
                    onClick={onOpenAdmin}
                  ...
                  <div className="bg-[#fff8f2] flex flex-row gap-[6.765px] items-center justify-center overflow-clip p-[9.02px] rounded-[9.02px] w-full max-w-[280px] cursor-pointer hover:bg-[#f5ede4] transition-colors">
  ...
  return (
    <div className="flex h-screen bg-white">
      ...
      {/* Mobile Modal - Always render on mobile, conditional on shouldUseMobile */}
      {shouldUseMobile && <MobileBirdModal />}
      ...
      {!shouldUseMobile && (
        ...
        <div className="flex flex-col items-start justify-between pb-10 pt-[17px] px-[26px] h-full">
          ...
          <div className="flex items-center justify-between p-0 w-full mb-0">
            ...
            {/* Title */}
            <h1 
              className="font-bold italic leading-[0] text-[#856658] text-[22.5px] text-left text-nowrap"
              style={{ 
                fontFamily: 'Cormorant, serif'
              }}
            >
          ...
          {/* Footer with Action Buttons */}
          <div className="[flex-flow:wrap] flex gap-3.5 h-[78.081px] items-start justify-center p-0 w-full">
            <div className="flex flex-row gap-[6.765px] items-center justify-center overflow-clip p-[16px] rounded-[9.02px] cursor-pointer hover:bg-[#F2DFD3] transition-all duration-300 ease-in-out px-[16px] py-[20px]">
              <div 
                className="font-semibold leading-[0] text-[#856658] text-[14px] text-left text-nowrap"
                style={{ fontFamily: 'Crimson Text, serif' }}
              >
            ...
            <div className="h-full flex flex-col literary-sidebar collapsed-sidebar">
              <div className="flex flex-col items-start justify-between px-2.5 py-[17px] h-full">
                ...
                <div className="flex flex-col gap-[15px] items-center justify-start shrink-0">
                  {/* Logo */}
                  <div className="bg-[#856658] overflow-clip relative rounded-bl-[2px] rounded-br-[4px] rounded-tl-[4px] rounded-tr-[4px] shrink-0 size-8 sidebar-logo">
                    <div className="absolute left-[13px] size-[19px] top-0">
                      <svg
                        className="block size-full"
                        fill="none"
