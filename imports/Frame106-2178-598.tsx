import svgPaths from "./svg-gvoxc2fscg";
...
export default function Frame106() {
  return (
    <div className="box-border content-stretch flex flex-row gap-[31px] items-center justify-start p-0 relative size-full">
      <ManageBirds />
      <Frame107 />
      <Frame108 />
    </div>
